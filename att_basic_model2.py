...
class AttBasicModel(BasicModel):
    def __init__(self):
        ...
        if cfg.MODEL.ATT_FEATS_EMBED_DIM > 0:
            sequential.append(nn.Linear(7, cfg.MODEL.ATT_FEATS_EMBED_DIM))
        ...
        self.self_attention = SelfAttention(1024, 1024)  # Self-Attention layer
    ...
    def preprocess(self, **kwargs):
        ...
        # print(att_feats.shape)
        # exit(0)
        att_featsSA = self.self_attention(att_feats, gtt_feats)
        # att_feats2 = self.linear_layer(att_feats1)
        att_feats = torch.cat((att_feats, att_featsSA), dim=2)
